...
public class AddressPagerAdapter extends PagerAdapter {
    ...
    private boolean needSteet = true;

    public AddressPagerAdapter(Context context, ViewPager viewPager) {
            ...
            public void onItemClick(String itemName, int addressPos) {
                ...
                switch (position) {
                    case 0:
                        ...
                        //遍历得到该省下的市级列表
                        for (Province.ArrayCity city : provinces.get(pPosition).array) {
                    ...
                    case 1:
                        ...
                        for (Province.ArrayRegion region : provinces.get(pPosition).array.get(cPosition).array) {
                    ...
                    case 2:
                        ...
                        //该区是否有街道的列表
                        if (needSteet && provinces.get(pPosition).array.get(cPosition).array.get(rPosition).array != null
