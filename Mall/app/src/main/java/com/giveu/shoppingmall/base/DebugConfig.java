...
public class DebugConfig {
	...
	private static String DOMAIN_TEST = "http://wx.dafycredit.cn/";//域名
	private static String DOMAIN_ONLINE = "http://3c.dafysz.cn/";//域名


    public static final String API_VERSION = "1.0/";//api版本，开发，正式环境可用
    ...
    public static String BASE_URL_DEV = DOMAIN_TEST + "3c-web/" + API_VERSION;//开发环境
