...
public class PullDetailLayout extends ViewGroup {
    ...
    public PullDetailLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.PullDetailLayout, defStyleAttr, 0);
        mPercent = a.getFloat(R.styleable.PullDetailLayout_percent, DEFAULT_PERCENT);
        mDuration = a.getInt(R.styleable.PullDetailLayout_duration, DEFAULT_DURATION);
        mDefaultPanel = a.getInt(R.styleable.PullDetailLayout_default_panel, 0);
        a.recycle();
