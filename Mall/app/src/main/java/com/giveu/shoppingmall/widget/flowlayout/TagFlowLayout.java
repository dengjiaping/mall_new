package com.giveu.shoppingmall.widget.flowlayout;
...
public class TagFlowLayout extends FlowLayout implements TagAdapter.OnDataChangedListener {
    ...
    public TagFlowLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, com.giveu.shoppingmall.R.styleable.TagFlowLayout);
        mAutoSelectEffect = ta.getBoolean(com.giveu.shoppingmall.R.styleable.TagFlowLayout_auto_select_effect, true);
        mSelectedMax = ta.getInt(com.giveu.shoppingmall.R.styleable.TagFlowLayout_max_select, -1);
        ta.recycle();
