 ...
 */
package com.giveu.shoppingmall.utils.explosionfield;
...
public class ExplosionField extends View {
    ...
    public static ExplosionField attach2Window(Dialog dialog) {
        ViewGroup rootView = (ViewGroup) dialog.findViewById(Window.ID_ANDROID_CONTENT);
        ExplosionField explosionField = new ExplosionField(dialog.getContext());
