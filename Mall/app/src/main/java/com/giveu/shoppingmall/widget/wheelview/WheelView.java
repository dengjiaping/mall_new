...
package com.giveu.shoppingmall.widget.wheelview;
...
import com.giveu.shoppingmall.widget.wheelview.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private int centerRectColor = R.color.android_default_dialog_title;
	private float centerRectStrokeWidth = 5.0f;
	...
	//modify by zfl
	private float itemLayoutHeight = 60f;//手动设置item高度
	public void setItemLayoutHeight(float itemLayoutHeight) {
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(centerRectColor));
		// 设置线宽
		paint.setStrokeWidth(centerRectStrokeWidth);
		// 绘制上边直线
...
//				itemsLayout.addView(view, 0);
				itemsLayout.addView(view, 0, new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, DensityUtils.dip2px(itemLayoutHeight)));
			} else {
				itemsLayout.addView(view, new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, DensityUtils.dip2px(itemLayoutHeight)));
